...
module.exports = {
  ...
  description: "renew channel your channel",
  usage: "",
  /**
   * @param {Client} client
    ...
    collector.on("collect", (buttonInteraction) => {
      ...
      if (id === "YES") {
        message.channel.clone().then((ch) => {
          ...
          let embed = new MessageEmbed().setTitle("**Channel Succesfuly Nuked**").setColor("303136").setDescription(reason).setImage("https://media0.giphy.com/media/oe33xf3B50fsc/200.gif");
